...
class Bird:
    def __init__(self):
        ...
        self.xScreen, self.yScreen = 600, 600
        linkBackGround = 'flappybird/data/background.jpg'
        self.linkImgBird = "flappybird/data/bird.png"
    ...
    def colunm(self):
        ...
        self.image_draw("flappybird/data/colunm.png", self.xColunm,
        ...
        while self.gamerunning:
            ...
            for event in pygame.event.get():  # Bắt các sự kiện
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    self.music("flappybird/data/wet-click.wav")
